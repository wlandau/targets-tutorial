...
`targets` also supports static branching, an alternative kind of shorthand. This course does not cover it, but it is easier to understand just by reading about it: <https://books.ropensci.org/targets/static.html>.
