...
* `targets` was created to overcome these limitations and create a smoother user experience.
    ...
    1. Designed for custom user-side [metaprogramming](https://wlandau.github.io/targets-manual/branching.html#metaprogramming) and target archetypes: <https://docs.ropensci.org/tarchetypes/>.
...
* These slides: <https://docs.ropensci.org/targets-tutorial>
