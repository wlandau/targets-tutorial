...
To implement the customer churn prediction workflow, you will create a `targets` pipeline. A `drake` plan is a data frame with code. It has the *targets* you will build and the R *commands* to build those targets. Helpful references:
