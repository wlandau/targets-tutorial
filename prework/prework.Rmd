...
Welcome to the short course on Reproducible Computation at Scale in R. Through guided hands-on exercises, you will learn how to use the [`targets`](https://docs.ropensci.org/targets/) R package, and you will build a pipeline that efficiently brings results up to date in response to changing code and data.
