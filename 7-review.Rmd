...
3. This chapter includes a modified set of functions in `7-review/functions.R`. `test_model()` now omits some hyperparameters but includes the sizes of the training and testing datasets. Here is an example collection of model runs.

```{r}
readRDS("7-review/runs.rds")
```
