...
Sometimes, we may not want to aggregate all the branches into a vector or data frame. Set `iteration = "list"` in `tar_target()` for the `run` target. Then, run the pipeline.
