...
In `targets`, we configure output files the exact same way. The only difference between input and output files is that output files are created by the file target that watches them.
